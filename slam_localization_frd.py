...
class SlamLocalization(Node):
    def __init__(self,vehicle):
        ...
        self.prev_time = None
        self.prev_vel = None
        self.timer = self.create_timer(0.08, self.timer_callback) # Timer at 100 Hz
        self.last_msg = None
    ...
    def timer_callback(self):
        if self.last_msg:
            ...
            cam_yaw = -attitude[0] #camera should be forward initially to remove cam_yaw ambiguity before facing it down
